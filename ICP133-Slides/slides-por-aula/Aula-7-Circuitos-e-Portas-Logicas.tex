...
\begin{frame}{Resumo: Portas lógicas}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/resumo-portas-logicas.png}
...
\begin{frame}{Resumo: Tabelas verdades das portas lógicas}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/tabelas-verdades-portas-logicas.png}
...
\begin{frame}{Teoremas Booleanos - uma única variável}
    Ler no livro - Pag. 67.
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figuras/teorema-booleano-1var.png}

    \end{figure}
\end{frame}

\begin{frame}{Teoremas Booleanos - com mais de uma variável}
    Ler no livro - Pag. 68.
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figuras/teorema-booleano-mais1var.png}

    \end{figure}
\end{frame}

\begin{frame}{Teoremas Booleanos - teoremas de DeMorgan}
    Ler no livro - Pag. 70.

    \textbf{Os teoremas de DeMorgan são muito úteis na simplificação de expressões nas quais um produto ou uma soma de variáveis aparecem negados (barrados).}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figuras/teorema-booleano-demorgan.png}

    \end{figure}

    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figuras/de-morgan-maisde1var.png}

    \end{figure}
\end{frame}

\begin{frame}{Todos os Teoremas Booleanos}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/teoremas-booleanos-all.png}

    \end{figure}
\end{frame}

\begin{frame}{Exercício de Simplificação 1}
    \begin{block}{Questão}
    ...
    \vspace{0.5cm}
    \begin{itemize}
        \item Aplique os teoremas da álgebra booleana para simplificar a expressão.
    \end{itemize}
\end{frame}

\begin{frame}{Exercício de Simplificação 1 (Gabarito)}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/exercicio-teorema1.png}

    \end{figure}
\end{frame}

\begin{frame}{Exercício de Simplificação 2}
    \begin{block}{Questão}
        Simplifique a expressão:
        \[ z = (\bar{A} + B)(A + B) \]
    \end{block}
...
\begin{frame}{Exercício de Simplificação 2 (Gabarito)}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/exercicio-teorema2.png}

    \end{figure}
\end{frame}


\begin{frame}{Exercício de Simplificação 3 }
    \begin{block}{Questão}
        Simplifique a expressão:
        \[ x = ACD + \bar{A}BCD \]
    \end{block}
...
\begin{frame}{Exercício de Simplificação 3 (Gabarito)}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/exercicio-teorema3.png}

    \end{figure}
\end{frame}

\begin{frame}{Exercício de Simplificação 4}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/enunciado-exercico-teorema4.png}

    \end{figure}
\end{frame}

\begin{frame}{Exercício de Simplificação 4 (Gabarito)}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/exercicio-teorema4.png}

    \end{figure}
\end{frame}

\begin{frame}{Exercício de Simplificação 5 (Gabarito)}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/exercicio-teorema5.png}

    \end{figure}
\end{frame}

\begin{frame}{Exercício de Simplificação 6 (Gabarito)}

    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figuras/exercicio-teorema6.png}
