...
\begin{frame}{Conversão de Base $B$ para Base 10}
...
\begin{frame}{Exemplos de Conversão: Binário e Octal}
    \begin{itemize}
        \item \textbf{De Binário ($B=2$):} $10100,1_2$
              {\small
...
\begin{frame}{Exemplos de Conversão: Hexadecimal}
    \begin{itemize}
        \item \textbf{De Hexadecimal ($B=16$):} $C3_{16}$
    \end{itemize}
...
\begin{frame}{Conversão de Decimal para Base $B$}
    \begin{itemize}
...
\begin{frame}{Conversão Mecânica: $352_{10}$ para Octal}
...
\begin{frame}{Exercício}
    ...
    \begin{enumerate}[a)]
        \item Base 10 (apenas para referência)
        \item Base 2
        \item Base 8
        \item Base 16
    \end{enumerate}
    ...
    \vspace{0.3cm}
    \begin{alertblock}{Atenção no Hexadecimal!}
        Se o resto for entre 10 e 15, não esqueça de converter para as letras \textbf{A} a \textbf{F} no resultado final.
    \end{alertblock}
\end{frame}